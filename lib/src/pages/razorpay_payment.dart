...
class _RazorPayPaymentWidgetState extends StateMVC<RazorPayPaymentWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    print(Provider.of<TotalProvider>(context, listen: false).getMethod());
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          InAppWebView(
            initialUrl: _con.url +
                '&_delivery_or_pickup=${Provider.of<TotalProvider>(context, listen: false).getMethod()}&total=${Provider.of<TotalProvider>(context, listen: false).getTotal()}&finalTax=${Provider.of<TotalProvider>(context, listen: false).getFinalTax()}&deliveryFee=${Provider.of<TotalProvider>(context, listen: false).getDeliveryFee()}',
            initialHeaders: {},
