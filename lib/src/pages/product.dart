...
class _ProductWidgetState extends StateMVC<ProductWidget> {
  ...
  Future<void> createDynamicLink(bool short) async {
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: Constant.uri,
      link: Uri.parse(Constant.uri +
          '/Product?productId=${_con.product.id}&herotag=${widget.routeArgument.heroTag}'),
      ...
      socialMetaTagParameters: SocialMetaTagParameters(
        title: '${_con.product.name}',
        description: '${_con.product.description}',
      ),
    );
    if (short) {
      final ShortDynamicLink shortDynamicLink =
          await parameters.buildShortLink();
      print(shortDynamicLink.shortUrl.toString());
                          ...
                          child: Padding(
                            ...
                            child: Wrap(
                              ...
                              children: [
                                ...
                                ListTile(
                                  onTap: () {
                                    createDynamicLink(true).then(
                                        (value) => Share.share(url.toString()));
                                    // Share.share(
                                    //     'Product : ${_con.product.name} '
                                    //     ' Price : ${_con.product.price} ');
                                    // Navigator.push(
                                    //   context,
                                    //   MaterialPageRoute(
                                    //     builder: (context) => SharedProduct(),
                                    //   ),
                                    // );
                                  },
                                  dense: true,
                                  ...
                                  subtitle: Text(
                                    'Click here to share this product',
