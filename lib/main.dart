...
import 'src/models/custom_fieldsss.dart';
import 'src/models/total_provider.dart';
import 'src/models/user_detailss.dart';
import 'package:provider/provider.dart';
import 'generated/l10n.dart' as L;
import 'route_generator.dart';
import 'src/helpers/app_config.dart' as config;
import 'src/helpers/custom_trace.dart';
import 'src/models/get_coupon.dart';
import 'src/models/selected_option.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider<CustomFieldsss>(
          create: (_) => CustomFieldsss(),
        ),
        Provider<TotalProvider>(
          create: (_) => TotalProvider(),
        ),
        Provider<SelectedOption>(
          create: (_) => SelectedOption(),
        ),
        Provider<GetCoupon>(
          create: (_) => GetCoupon(),
        ),
